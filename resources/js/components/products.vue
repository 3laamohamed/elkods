<template>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <form @submit.prevent="savProducts">
                    <div class="mb-3">
                        <label for="name" class="form-label">اسم المنتج</label>
                        <input v-model="name" type="text" class="form-control" id="name">
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">الكمية</label>
                        <input v-model="qty" type="text" class="form-control" id="name">
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">السعر</label>
                        <input v-model="price" type="text" class="form-control" id="name">
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">سعر البيع</label>
                        <input v-model="pay_price" type="text" class="form-control" id="name">
                    </div>
